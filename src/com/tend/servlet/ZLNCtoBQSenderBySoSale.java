 ...
 *
 */
public class ZLNCtoBQSenderBySoSale extends BaseDao implements Runnable {

	public ZLNCtoBQSenderBySoSale() {
	...
	public void run() {
		try {
			DateLoop(this.getBilldate(),this.getBegindate(), this.getEnddate(),this.getZday());
