 ...
 *
 */
public class ZLNCtoBQSenderByIcGeneralB extends BaseDao implements Runnable {

	public ZLNCtoBQSenderByIcGeneralB() {
	...
	public void run() {
		try {
			DateLoop("2012-10-15", "2013-01-01","2013-01-04",1);
