 ...
 *
 */
public class ZLNCtoBQSenderByArapDjzb extends BaseDao implements Runnable {

	public ZLNCtoBQSenderByArapDjzb() {
	 ...
	 * @throws Exception
	 */
	public void NCtoBQ(String dbilldate,String start,String end) throws Exception {
		...
		try {
			...
			sql.append(" where z.djrq >= '").append(dbilldate+"'");
