...
public class NCtoBQSenderByIcGeneralB extends BaseDao implements Runnable {

	public NCtoBQSenderByIcGeneralB() {
		System.out.println("NCtoBQSenderByIcGeneralB 无参构造函数");
	}
	...
	public void DateLoop(String begindate,String enddate,int days) throws Exception{
		...
		System.out.println("出入库单辅表时间区间："+sdf.format(date1)+" to "+sdf.format(datetemp));
		...
		while(mm.dateCompare(datetemp , date2)){
			...
			if(mm.dateCompare(date2  ,datetemp )){
				System.out.println("出入库单辅表时间区间："+sdf.format(mm.getDateAfterDay(datetemp, -days))+" to "+sdf.format(date2));
				NCtoBQ(sdf.format(mm.getDateAfterDay(datetemp, -days)), sdf.format(date2));
			}else{
				System.out.println("出入库单辅表时间区间："+sdf.format(mm.getDateAfterDay(datetemp, -days))+" to "+sdf.format(datetemp));
	...
	public void NCtoBQ(String beginDate,String endDate) throws Exception {
		...
		System.out.println("出入库单辅表开始抽取数据................");
		...
		try {
			...
			System.out.println("出入库单辅表数据抽取完毕");
