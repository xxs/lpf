...
public class DownFileServlet1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String filepath = request.getRealPath(request.getParameter("filepath"));
		System.out.println(filepath);
		File file = new File(filepath);
		if(file.exists()){
			try{System.out.println(response.getCharacterEncoding());
