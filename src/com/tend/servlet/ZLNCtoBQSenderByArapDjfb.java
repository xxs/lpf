 ...
 *
 */
public class ZLNCtoBQSenderByArapDjfb extends BaseDao implements Runnable {

	public ZLNCtoBQSenderByArapDjfb() {
	...
	public void run() {
		try {
			DateLoop("2013-01-01","2013-04-01", "2013-06-27",1);
	...
	public void NCtoBQ(String dbilldate,String start,String end) throws Exception {
		...
		try {
			...
			sql.append("                    and z.djrq >= '").append(dbilldate+"'");
