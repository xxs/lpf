...
public class NCtoBQSenderBySoSaleinvoiceB extends BaseDao implements Runnable {

	public NCtoBQSenderBySoSaleinvoiceB() {
		System.out.println("NCtoBQSenderBySoSaleinvoiceB 无参构造函数");
	}
	...
	public void NCtoBQ(String beginDate,String endDate) throws Exception {
		...
		try {
			...
			while(restNC.next()){
				...
				insetSql.append("insert into DWT_SO_SALEINVOICE_B ( ");
